      ...
      <div className='max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16'>
        ...
        >
          ...
          <p className='mt-2 text-gray-500 max-w-3xl mx-auto'>
            Searching for your dream rental property has never been easier. With our user-friendly search feature, you can quickly find the perfect home that meets all of your needs. Start your search today and discover your dream rental property!
          </p>
        </motion.div>
